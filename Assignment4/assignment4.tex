...
\end{align}
Taking \textbf{Natural Logarithm} on both sides of \eqref{eq_log}
\begin{align}
     \implies log_e (\pr{A'})^n &\le log_e \frac{1}{2}\\
     \implies n\cdot log_e \frac{99}{100} &\le log_e \frac{1}{2}\\
     \implies n &\ge \frac{log_e \frac{1}{2}}{log_e \frac{99}{100}}\\
