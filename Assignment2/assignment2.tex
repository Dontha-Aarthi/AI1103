...
\centering
    ...
    \hline
    $\Delta t$ & One time interval & $\Delta t$=T/n & Yes\\
    \hline
...
To find the probability of $k$ number of calls during this time interval, lets divide the interval into $n$ parts.
...
\begin{figure}[!hbt]
    ...
    \label{fig_0}
\end{figure}\\
In Fig. \ref{fig_0}, Let $t_i$ denote random variable, where $t_i \in$ (0,$T$) for $i=1,2,3...n-1$, and the number of calls in time t, where $t=t_4-t_2$ is $(\lambda\cdot t)/T$.\\
